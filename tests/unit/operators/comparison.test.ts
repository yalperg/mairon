...
describe('comparison operators', () => {
  ...
  test('equals and notEquals', () => {
    ...
    expect(equals(5, { field: 'x', operator: 'equals', value: 5 }, ctx)).toBe(
      true,
    );
    expect(
      equals(
    ...
    expect(
      notEquals('a', { field: 'x', operator: 'notEquals', value: 'b' }, ctx),
    ).toBe(true);
  });
  ...
  test('greaterThan/lessThan', () => {
    ...
    expect(gt(10, { field: 'x', operator: 'greaterThan', value: 5 }, ctx)).toBe(
      true,
    );
    expect(lt(3, { field: 'x', operator: 'lessThan', value: 5 }, ctx)).toBe(
      true,
    );
    expect(
      gt('10', { field: 'x', operator: 'greaterThan', value: '9' }, ctx),
    ).toBe(true);
    expect(lt('a', { field: 'x', operator: 'lessThan', value: 'b' }, ctx)).toBe(
      false,
    );
  });
  ...
  test('gte/lte', () => {
    ...
    expect(
      gte(5, { field: 'x', operator: 'greaterThanOrEqual', value: 5 }, ctx),
    ).toBe(true);
    expect(
      lte(5, { field: 'x', operator: 'lessThanOrEqual', value: 5 }, ctx),
    ).toBe(true);
  });
  ...
  test('between', () => {
    ...
    expect(
      between(5, { field: 'x', operator: 'between', value: [1, 10] }, ctx),
    ).toBe(true);
    expect(
      between(
        new Date('2020-01-02'),
    ...
    expect(
      between('x', { field: 'x', operator: 'between', value: [1, 3] }, ctx),
    ).toBe(false);
    expect(
      between(5, { field: 'x', operator: 'between', value: [10, 20] }, ctx),
    ).toBe(false);
  });
});
